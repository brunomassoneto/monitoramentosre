...
class Oferta:
    ...
    __slots__ = ("id", "processo", "protocolo", "tipo", "emissor",
                 ...
                 "rito", "categorias", "fase", "devedor", "fonte")
...
def verificar(dry_run: bool = False, notificar_primeira: bool = False) -> None:
    ...
    # Para as ofertas novas que são CRA/CRI e vieram do SRE, busca o devedor.
    if sess is not None:
        for o in eventos:
            if o.eh_cri_cra() and o.id:
...
def modo_inspect() -> None:
    ...
    # exemplo de mensagem (busca o devedor de um CRA/CRI de exemplo)
